      ...
      <div className="photo-mask">
        ...
        <div className="container position-relative" style={{ height: '100%' }}>
          ...
          <div className="category-choose d-flex flex-column align-items-center">
                <a href="#!" className="category-choose-btn d-inline-block py-3 px-5 mb-5 ">按類別購物</a>
                <ul className="d-flex list-unstyled w-100 justify-content-center">
                    <li><a href="#!" className="mx-4 ">上衣</a></li>
                    <li><a href="#!" className="mx-4 ">下身</a></li>
                    <li><a href="#!" className="mx-4 ">外套</a></li>
                    <li><a href="#!" className="mx-4 ">配件</a></li>
                </ul>
            </div>
        </div>
