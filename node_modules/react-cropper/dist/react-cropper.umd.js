...
var ReactCropper = React__default['default'].forwardRef(function (_a, ref) {
    ...
    var _d = React.useState(undefined), cropper = _d[0], setCropper = _d[1];
    ...
    React.useEffect(function () {
        if (combinedRef.current !== null) {
            var cropper_1 = new Cropper__default['default'](combinedRef.current, __assign(__assign({ dragMode: dragMode }, rest), { ready: function (e) {
                    if (e.target !== null) {
                        var target = e.target;
            ...
            onInitialized && onInitialized(cropper_1);
            setCropper(cropper_1);
        }
        /**
    ...
    return (React__default['default'].createElement("div", { style: style, className: className },
        React__default['default'].createElement("img", { crossOrigin: crossOrigin, src: src, alt: alt, style: { opacity: 0, maxWidth: '100%' }, ref: combinedRef })));
});
